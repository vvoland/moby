...
func DefaultProfile() *Seccomp {
	...
	syscalls := []*Syscall{
		...
		// NOTE: socketcall(2) is allowed unconditionally above. On i386,
		// glibc routes socket() through socketcall which means seccomp
		// cannot filter AF_ALG via arg inspection for 32-bit binaries.
		// AppArmor's "deny network alg," rule covers this gap on systems
